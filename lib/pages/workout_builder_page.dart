...
const List<_Exercise> _allExercises = [
  ...
  _Exercise('NeckRotationLeft', _Category.mobility),
  _Exercise('NeckRotationRight', _Category.mobility),
  ...
  _Exercise('ShoulderExternalRotationForwardLeanLeft', _Category.mobility),
  _Exercise('ShoulderExternalRotationForwardLeanRight', _Category.mobility),
  _Exercise('ShoulderExternalRotationLeft', _Category.mobility),
  _Exercise('ShoulderExternalRotationRight', _Category.mobility),
  _Exercise('ShoulderInternalRotationForwardLeanLeft', _Category.mobility),
  _Exercise('ShoulderInternalRotationForwardLeanRight', _Category.mobility),
  _Exercise('ShoulderInternalRotationLeft', _Category.mobility),
  _Exercise('ShoulderInternalRotationRight', _Category.mobility),
